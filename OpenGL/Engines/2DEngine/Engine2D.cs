...
public class Engine2D {
  private string ProjectPath { get; } = Directory.GetCurrentDirectory();
  ...
  public void DrawRectangle(int x, int y, int r, int g, int b) {
    ...
    _shader = new Shader(ProjectPath + @"/Rendering/Shaders/vertex.glsl",
      ProjectPath + @"/Rendering/Shaders/fragment.glsl");
    _shader.Load();
